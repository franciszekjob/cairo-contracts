use openzeppelin_test_common::mocks::upgrades::{
    IUpgradesV1Dispatcher, IUpgradesV1DispatcherTrait, IUpgradesV2Dispatcher,
    IUpgradesV2DispatcherTrait,
};
...
fn test_remove_selector_fails_in_v2() {
    ...
    let dispatcher = IUpgradesV1Dispatcher { contract_address: v1.contract_address };
    dispatcher.remove_selector();
}
